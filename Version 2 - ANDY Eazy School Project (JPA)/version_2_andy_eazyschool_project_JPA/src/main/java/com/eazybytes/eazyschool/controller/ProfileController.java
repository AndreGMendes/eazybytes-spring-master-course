...
public class ProfileController {
   ...
   @RequestMapping("/displayProfile") /**Access from the dashboard.html*/
   public ModelAndView displayMessages (Model model, HttpSession session) {
       ...
       /**The connection between the "profile" object name in JAVA and the frontend UI
        * is being made in profile.html page
        * The object 'profile' here is sent to the UI: "... th:object= "${profile}" ..." */
